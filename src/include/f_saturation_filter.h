...
#ifndef REPO_GROUP_A01_SRC_INCLUDE_F_SATURATION_FILTER_H_
#define REPO_GROUP_A01_SRC_INCLUDE_F_SATURATION_FILTER_H_
...
#endif  // REPO_GROUP_A01_SRC_INCLUDE_F_SATURATION_FILTER_H_
