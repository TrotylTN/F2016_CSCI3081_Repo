bin/BrushWork: obj/main.o obj/base_gfx_app.o obj/brushwork_app.o obj/color_data.o obj/pixel_buffer.o | bin
	cd ext/glui && make
	g++ -L./ext/glui/lib -o bin/BrushWork obj/main.o obj/base_gfx_app.o obj/brushwork_app.o obj/color_data.o obj/pixel_buffer.o obj/mask.o -std=c++11 -lglut -lGL -lGLU -lglui
...
obj/brushwork_app.o: obj/mask.o obj/color_data.o obj/pixel_buffer.o obj/base_gfx_app.o src/brushwork_app.cc | obj
...
obj/mask.o: src/mask.cc | obj
	g++ -I. -c -o obj/mask.o src/mask.cc -std=c++11
